...
For the Helm chart that installs an ingress object, created another helm chart, but this one installs an ingress object of class Nginx.  
To install the Nginx ingress class, Visit https://kubernetes.github.io/ingress-nginx/deploy/#quick-start or just:  
